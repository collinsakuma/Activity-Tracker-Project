...
function CollinSProfile({ activities }) {
    ...
    return (
        <div className="profile">
            <div className="profile-header">
                <img className="profile-image" alt="Collin Sakuma" src="https://thumbs2.imgbox.com/7a/1b/9fyUyas3_t.png" style={{height: "100px"}}></img><h2>Collin Sakuma</h2>
            </div>
